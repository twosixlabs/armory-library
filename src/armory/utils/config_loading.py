...
from armory.data.datasets import AbstractArmoryDataGenerator, ArmoryDataGenerator, EvalGenerator
...
def load(sub_config):
    ...
    args = sub_config.args or []
    kwargs = sub_config.kwargs or {}
...
def load_model(model_config):
    ...
    weights_file = model_config.weights_file or None
